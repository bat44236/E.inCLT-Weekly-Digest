...
"""
    ...
    out = (
        ...
        f'<img src="data:image/png;base64,{img_b64}" style="display:block;margin:0 auto 20px auto;width:100%;max-width:{FIXED_WIDTH}px;height:auto;">\n'
    ...
    for tg in sorted(grouped.keys(), key=sort_key):
        ...
        h2_style = (
            ...
            if is_featured else
            "background-color:#004085;color:#fff;padding:10px;border-radius:8px;"
